#
#  Be sure to run `pod spec lint CSSwiftExtension.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Chris Hu"
  # s.authors            = { "Chris Hu" => "icetime17@126.com" }
  # s.social_media_url   = "http://twitter.com/Chris Hu"
