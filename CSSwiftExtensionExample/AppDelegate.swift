...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func testCSNetworkManager() {
        ...
        print("cs_getJSONObjectSynchronously : jsonObject: \(jsonObject)")
    }
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "icetime17.CSSwiftExtension" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("CSSwiftExtension", withExtension: "momd")!
